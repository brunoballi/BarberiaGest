-- 037: guarda el facturado de los días que el barbero nuevo trabajó por comisión
-- (día_neto > doble), para poder mostrar en la grilla "40% de $95.000" en la
-- columna "Comisión base". Solo agrega barber_comision_facturado al cálculo del
-- barbero nuevo; el resto queda como en 036.

alter table settlements add column if not exists barber_comision_facturado numeric(12,2) not null default 0;
